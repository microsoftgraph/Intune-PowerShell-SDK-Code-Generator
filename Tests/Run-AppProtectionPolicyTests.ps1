...
$iosManagedAppProtection = New-AmManagedAP -iosManagedAppProtection -displayName "iOS MAM / APP Policy" `
...
Invoke-AmAssignIosAppApps -iosManagedAppProtectionId $iosManagedAppProtection.id `
