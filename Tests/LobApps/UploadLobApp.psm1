...
function WaitForFileProcessing($file, $stage) {
    ...
    $result = $null
    while ($attempts -gt 0) {
        $result = $file | Get-DeviceAppMgtMobileAppsContentVersionsFiles
...
function New-LobApp {
    ...
    try {
        ...
        $createdApp = $mobileApp | New-DeviceAppMgtMobileApps
        ...
        $contentVersion = $createdApp | New-DeviceAppMgtMobileAppsContentVersions
        ...
        $file = $contentVersion | New-DeviceAppMgtMobileAppsContentVersionsFiles `
        ...
        $file | Invoke-DeviceAppMgtMobileAppsContentVersionsFilesCommit -fileEncryptionInfo $encryptionResult.info
        ...
        $createdApp | Update-DeviceAppMgtMobileApps -committedContentVersion $contentVersion.id
