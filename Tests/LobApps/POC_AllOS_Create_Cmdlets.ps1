...
Write-Host "Adding Android Managed App Policy from PowerShell Module..." -ForegroundColor Yellow
...
write-host "Policy created with id" $androidManagedAppProtectionPolicy.id 
Write-Host
