...
$policy = New-IntuneAppProtectionPolicy `
...
$apps = Get-IntuneMobileApp -Expand assignments, categories | Where-Object { $_.'@odata.type' -like '#microsoft.graph.managed*' }
...
Invoke-IntuneAppProtectionPolicyIosTargetApp -iosManagedAppProtectionId $policy.id -apps $appIdentifiers
...
$groups | ForEach-Object {
    Invoke-IntuneAppProtectionPolicyIosAssign -iosManagedAppProtectionId $policy.id -assignments @(
...
$policy | Remove-IntuneAppProtectionPolicy