...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    [ResourceReference("deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtectionId ?? string.Empty}")]
    public class Get_DeviceAppManagement_DefaultManagedAppProtections : GetOrSearchCmdlet
    {
        ...
        ///     <para type="description">This property is on the &quot;microsoft.graph.defaultManagedAppProtection&quot; type.</para>
        ///     <para type="description">Maximum number of incorrect pin retry attempts before the managed app is wiped.</para>
        /// </summary>
        [ODataType("Edm.Int32")]
        [Selectable]
        [Sortable]
    ...
    ///     <para type="description">DELETE ~/deviceAppManagement/defaultManagedAppProtections</para>
    ...
    [ODataType("microsoft.graph.defaultManagedAppProtection")]
    [ResourceReference("deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtectionId}")]
