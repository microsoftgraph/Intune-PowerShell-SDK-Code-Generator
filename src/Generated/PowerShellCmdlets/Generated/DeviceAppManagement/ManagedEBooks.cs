...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    [ResourceReference("deviceAppManagement/managedEBooks/{managedEBookId ?? string.Empty}")]
    public class Get_DeviceAppManagement_ManagedEBooks : GetOrSearchCmdlet
    {
        ...
        ///     <para type="description">This property is on the &quot;microsoft.graph.managedEBook&quot; type.</para>
        ///     <para type="description">The date and time when teh eBook was last modified.</para>
        /// </summary>
        [ODataType("Edm.DateTimeOffset")]
        [Selectable]
        [Sortable]
    ...
    ///     <para type="description">DELETE ~/deviceAppManagement/managedEBooks</para>
    ...
    [ODataType("microsoft.graph.managedEBook")]
    [ResourceReference("deviceAppManagement/managedEBooks/{managedEBookId}")]
