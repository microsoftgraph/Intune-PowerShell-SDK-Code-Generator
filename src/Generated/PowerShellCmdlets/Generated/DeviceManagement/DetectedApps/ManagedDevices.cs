...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    ///     <para type="description">DELETE ~/deviceManagement/detectedApps/{detectedAppId}/managedDevices</para>
    ...
    ///     <para type="description">POST ~/deviceManagement/detectedApps/{detectedAppId}/managedDevices</para>
    ...
    public class New_DeviceManagement_DetectedApps_ManagedDeviceReferences : PostReferenceToCollectionCmdlet
    {
        ...
        {
            return this.GetODataIdContent(managedDeviceId);
        }
    }
}