...
namespace PowerShellGraphSDK.PowerShellCmdlets
{
    ...
    [ResourceReference("deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummaryId ?? string.Empty}")]
    ...
    ///     <para type="description">DELETE ~/deviceManagement/deviceCompliancePolicySettingStateSummaries</para>
    ...
    [ODataType("microsoft.graph.deviceCompliancePolicySettingStateSummary")]
    [ResourceReference("deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummaryId}")]
    ...
    public class New_DeviceManagement_DeviceCompliancePolicySettingStateSummaries : PostCmdlet
    {
        ...
        ///          Valid values: &apos;android&apos;, &apos;iOS&apos;, &apos;macOS&apos;, &apos;windowsPhone81&apos;, &apos;windows81AndLater&apos;, &apos;windows10AndLater&apos;, &apos;all&apos;
        ///     </para>
        /// </summary>
        [ODataType("microsoft.graph.policyPlatformType")]
        [Selectable]
        [ValidateSet(@"android", @"iOS", @"macOS", @"windowsPhone81", @"windows81AndLater", @"windows10AndLater", @"all")]
