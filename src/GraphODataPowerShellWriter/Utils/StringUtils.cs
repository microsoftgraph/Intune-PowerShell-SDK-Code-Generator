...
namespace Microsoft.Graph.GraphODataPowerShellSDKWriter.Utils
{
    ...
    public static class StringUtils
    {
        ...
        private static readonly Dictionary<string, string> ShortNounName = new Dictionary<string, string>
        {
            ...
            #endregion
            #region DirectoryObjects
            { "DirectoryObjects_CreatedObjects", "DirectoryObjectsCreatedObjects" },            
            { "DirectoryObjects_CreatedOnBehalfOf", "DirectoryObjectsCreatedOnBehalfOf" },
            { "DirectoryObjects_CreatedOnBehalfOfReference", "DirectoryObjectsCreatedOnBehalfOfReference" },
            { "DirectoryObjects_DeviceManagementTroubleshootingEvents", "DirectoryObjectsDeviceManagementTroubleshootingEvents" },
            { "DirectoryObjects_DirectReports", "DirectoryObjectsDirectReports" },
            { "DirectoryObjects_DirectReportsReferences", "DirectoryObjectsDirectReportsReferences" },
            { "DirectoryObjects_Extensions", "DirectoryObjectsExtensions" },
            { "DirectoryObjects_GroupLifecyclePolicies", "DirectoryObjectsGroupLifecyclePolicies" },
            { "DirectoryObjects_InferenceClassification", "DirectoryObjectsInferenceClassification" },
            { "DirectoryObjects_InferenceClassification_Overrides", "DirectoryObjectsInferenceClassificationOverrides" },
            { "DirectoryObjects_LicenseDetails", "DirectoryObjectsLicenseDetails" },
            { "DirectoryObjects_ManagedAppRegistrations", "DirectoryObjectsManagedAppRegistrations" },
            { "DirectoryObjects_ManagedAppRegistrationsReferences", "DirectoryObjectsManagedAppRegistrationsReferences" },
            { "DirectoryObjects_ManagedDevices", "DirectoryObjectsManagedDevices" },
            { "DirectoryObjects_ManagedDevices_DeviceCategory", "DirectoryObjectsManagedDevicesDeviceCategory" },
            { "DirectoryObjects_ManagedDevices_DeviceCompliancePolicyStates", "DirectoryObjectsManagedDevicesDeviceCompliancePolicyStates" },
            { "DirectoryObjects_ManagedDevices_DeviceConfigurationStates", "DirectoryObjectsManagedDevicesDeviceConfigurationStates" },
            { "DirectoryObjects_Manager", "DirectoryObjectsManager" },
            { "DirectoryObjects_ManagerReference", "DirectoryObjectsManagerReference" },
            { "DirectoryObjects_MemberOf", "DirectoryObjectsMemberOf" },
            { "DirectoryObjects_MemberOfReferences", "DirectoryObjectsMemberOfReferences" },
            { "DirectoryObjects_Members", "DirectoryObjectsMembers" },
            { "DirectoryObjects_MembersReferences", "DirectoryObjectsMembersReferences" },
            { "DirectoryObjects_OwnedDevices", "DirectoryObjectsOwnedDevices" },
            { "DirectoryObjects_OwnedDevicesReferences", "DirectoryObjectsOwnedDevicesReferences" },
            { "DirectoryObjects_OwnedObjects", "DirectoryObjectsOwnedObjects" },
            { "DirectoryObjects_OwnedObjectsReferences", "DirectoryObjectsOwnedObjectsReferences" },
            { "DirectoryObjects_Owners", "DirectoryObjectsOwners" },
            { "DirectoryObjects_OwnersReferences", "DirectoryObjectsOwnersReferences" },
            { "DirectoryObjects_Photo", "DirectoryObjectsPhoto" },
            { "DirectoryObjects_PhotoData", "DirectoryObjectsPhotoData" },
            { "DirectoryObjects_Photos", "DirectoryObjectsPhotos" },
            { "DirectoryObjects_PhotosData", "DirectoryObjectsPhotosData" },
            { "DirectoryObjects_RegisteredDevices", "DirectoryObjectsRegisteredDevices" },
            { "DirectoryObjects_RegisteredDevicesReferences", "DirectoryObjects_RegisteredDevicesReferences" },
            { "DirectoryObjects_RegisteredOwners", "DirectoryObjectsRegisteredOwners" },
            { "DirectoryObjects_RegisteredOwnersReferences", "DirectoryObjectsRegisteredOwnersReferences" },
            { "DirectoryObjects_RegisteredUsers", "DirectoryObjectsRegisteredUsers" },
            { "DirectoryObjects_RegisteredUsersReferences", "DirectoryObjectsRegisteredUsersReferences" },
            { "DirectoryObjects_Settings", "DirectoryObjectsSettings" },
            { "DirectoryObjects_CheckMemberGroups", "DirectoryObjectsCheckMemberGroups" },
            { "DirectoryObjects_GetByIds", "DirectoryObjectsGetByIds" },
            { "DirectoryObjects_GetMemberGroups", "DirectoryObjects_GetMemberGroups" },
            { "DirectoryObjects_GetMemberObjects", "DirectoryObjects_GetMemberObjects" },
            { "DirectoryObjects_GroupLifecyclePolicies_AddGroup", "DirectoryObjectsGroupLifecyclePoliciesAddGroup" },
            { "DirectoryObjects_GroupLifecyclePolicies_RemoveGroup", "DirectoryObjectsGroupLifecyclePoliciesRemoveGroup" },
            { "DirectoryObjects_ManagedDevices_BypassActivationLock", "DirectoryObjectsManagedDevicesBypassActivationLock" },
            { "DirectoryObjects_ManagedDevices_CleanWindowsDevice", "DirectoryObjectsManagedDevicesCleanWindowsDevice" },
            { "DirectoryObjects_ManagedDevices_DeleteUserFromSharedAppleDevice", "DirectoryObjectsManagedDevicesDeleteUserFromSharedAppleDevice" },
            { "DirectoryObjects_ManagedDevices_DisableLostMode", "DirectoryObjectsManagedDevicesDisableLostMode" },
            { "DirectoryObjects_ManagedDevices_LocateDevice", "DirectoryObjectsManagedDevicesLocateDevice" },
            { "DirectoryObjects_ManagedDevices_LogoutSharedAppleDeviceActiveUser", "DirectoryObjectsManagedDevicesLogoutSharedAppleDeviceActiveUser" },
            { "DirectoryObjects_ManagedDevices_RebootNow", "DirectoryObjectsManagedDevicesRebootNow" },
            { "DirectoryObjects_ManagedDevices_RecoverPasscode", "DirectoryObjectsManagedDevicesRecoverPasscode" },
            { "DirectoryObjects_ManagedDevices_RemoteLock", "DirectoryObjectsManagedDevicesRemoteLock" },
            { "DirectoryObjects_ManagedDevices_RequestRemoteAssistance", "DirectoryObjectsManagedDevicesRequestRemoteAssistance" },
            { "DirectoryObjects_ManagedDevices_ResetPasscode", "DirectoryObjectsManagedDevicesResetPasscode" },
            { "DirectoryObjects_ManagedDevices_Retire", "DirectoryObjectsManagedDevicesRetire" },
            { "DirectoryObjects_ManagedDevices_ShutDown", "DirectoryObjectsManagedDevicesShutDown" },
            { "DirectoryObjects_ManagedDevices_SyncDevice", "DirectoryObjectsManagedDevicesSyncDevice" },
            { "DirectoryObjects_ManagedDevices_UpdateWindowsDeviceAccount", "DirectoryObjectsManagedDevicesUpdateWindowsDeviceAccount" },
            { "DirectoryObjects_ManagedDevices_WindowsDefenderScan", "DirectoryObjectsManagedDevicesWindowsDefenderScan" },
            { "DirectoryObjects_ManagedDevices_WindowsDefenderUpdateSignatures", "DirectoryObjectsManagedDevicesWindowsDefenderUpdateSignatures" },
            { "DirectoryObjects_ManagedDevices_Wipe", "DirectoryObjectsManagedDevicesWipe" },
            { "DirectoryObjects_Restore", "DirectoryObjects_Restore" }
            #endregion
        };
